            ...
            for testlabel in groupedModelAnswers[entityType]:
                for questionID in groupedModelAnswers[entityType][testlabel]:
                    for question in groupedModelAnswers[entityType][testlabel][questionID]:
                        ...
                        # set of all given answers (including how many) 
                        if simplifyAnswer(question['response']) not in answerSet:
                            answerSet[simplifyAnswer(question['response'])] = 0
                        answerSet[simplifyAnswer(question['response'])] += 1
